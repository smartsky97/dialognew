...
public class Sample {
    ...
    private final String appKey = "ZcL3uxCrjKcZW73Z1POdamOO";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "RujZIvc4FObKiGuBxLL2da47uRVF3rfW";
    ...
    private void run() throws IOException, DemoException, JSONException {
